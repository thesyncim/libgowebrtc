...
- `PeerConnection.GetStats()` - returns empty map
- `RTPSender.SetParameters()` / `GetParameters()` - stubs
- `RTPTransceiver.SetDirection()` / `Stop()` - stubs
- `PeerConnection.AddTransceiver()` - partial implementation
